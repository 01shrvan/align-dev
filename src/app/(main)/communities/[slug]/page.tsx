                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            delete the community and all its content.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
          ...
          {!isMember ? (
            <div className="rounded-xl bg-background/30 p-10 sm:p-12 text-center shadow-[0_0_50px_-12px_rgba(0,0,0,0.1)] border border-border/40 relative">
              ...
              <p className="text-muted-foreground mb-4">
                You need to be a member to view and participate in this
                community
              </p>
                ...
                >
                  {posts.length === 0 ? (
                    ...
                    posts.map((post: any) => (
                      <div
                        key={post.id}
                        className="rounded-xl bg-background/30 p-5 sm:p-6 shadow-[0_0_50px_-12px_rgba(0,0,0,0.1)] border border-border/40 relative"
                      >
                        <div
                          className="absolute inset-0 z-[-1] opacity-[0.03] rounded-xl pointer-events-none"
                          style={{
